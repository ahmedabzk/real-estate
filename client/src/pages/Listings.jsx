...
export default function Listings() {
  ...
  return (
    <main>
      {loading && <p className="text-center mt-7 text-xl">loading...</p>}
      {error && (
        <p className="text-center text-red-700 mt-7 text-xl">{error}</p>
      )}
        ...
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto my-7 p-3 gap-4">
            <p className="text-2xl font-semibold">
              {listing.name} - Ksh{" "}
              {listing.offer
                ? listing.discountedPrice.toLocaleString("KES")
                : listing.regularPrice.toLocaleString("KES")}
            ...
            <div className="flex gap-4">
              <p className="bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-sm">
